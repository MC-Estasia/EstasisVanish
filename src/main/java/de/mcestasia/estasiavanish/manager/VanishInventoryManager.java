...
public class VanishInventoryManager {
    ...
    public String playerArmorToBase64(PlayerInventory playerInventory) throws IllegalStateException {
    ...
    public String itemStackArrayToBase64(ItemStack[] items) throws IllegalStateException {
        try {
            ...
            throw new IllegalStateException("Items konnten nicht gespeichert werden", exception);
        }
    }
    ...
    public Inventory fromBase64(String data) throws IOException {
        try {
            ...
            throw new IOException("Klassentyp konnte nicht deserialisiert werden!", exception);
        }
    }
